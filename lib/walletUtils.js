  ...
  try {
    if (input.witnessScript) {
      ...
      if (!input.sighashTypes) {
       input.sighashTypes = [bitcoin.Transaction.SIGHASH_ALL]; // Ensure sighashTypes is an array
      }
      psbt.signInput(index, keyPair, {
        witnessScript: input.witnessScript,
        sighashType: bitcoin.Transaction.SIGHASH_ALL, // Explicitly set sighashType here
      });
    } else {
